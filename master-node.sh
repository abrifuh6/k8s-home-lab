...
# Setup Complete - Provide Instructions for Next Steps
echo "Setup complete. You can now initialize your Kubernetes master node."
echo "Please run the following command to initialize the master node:"
echo "  sudo kubeadm init --pod-network-cidr=<your-pod-cidr>"

# Step 6: Installation Reminder for Calico Network Plugin
echo "After initializing the master node, install Calico by running:"
